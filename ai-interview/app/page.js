  ...
  return (
    <div>
      ...
      <section className=" z-50">
        <div className="py-20 px-4 mx-auto max-w-screen-xl text-center lg:py-28 lg:px-12">
          ...
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            ...
            <a href="https://github.com/jaiswalishika" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
      ...
      <div className="flex justify-center items-center">
        <footer className="mb-5">
          <span className="text-gray-900 text-lg ">Created By <span className="text-pink-800 font-medium">Ishika</span> | 2024 All rights reserved.</span>
        </footer>
      </div>
    </div>
